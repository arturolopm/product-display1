...
const DetailsProduct = () => {
    return(
        ...
        <p className=" mb-3 text-orange-primary font-bold uppercase tracking-wide">Sneaker Company</p>
        ...
        <div className=" mb-5 grid grid-cols-3 items-center gap-4 font-bold md:grid-cols-[1fr_3fr] md:gap-1">
          ...
          <span className=" text-right text-lg text-grayish-blue line-through md:text-left md:col-span-3">$250.00</span>
        </div>
