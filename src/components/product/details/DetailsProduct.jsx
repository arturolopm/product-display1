...
const DetailsProduct = ({objectProduct}) => {
    ...
    return(
        ...
        <div className=" grid grid-cols-3 gap-4 font-bold md:grid-cols-[1fr_1.5fr]">
          ...
          <button className=" col-span-3 flex items-center justify-center gap-x-3 rounded-md bg-orange-primary py-3 text-white transition-all hover:bg-orange-700 md:col-span-1" onClick={handleAddToCart}>
