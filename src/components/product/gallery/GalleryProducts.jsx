    ...
    return (
        <>
            <SlideProduct 
                ...
                className="grid place-items-center content-center md:grid-cols-4 md:gap-4"
            ...
            {isOpenModal && (
                ...
                <SlideProduct 
                    ...
                    className="hidden md:grid md:absolute md:-translate-y-1/2 md:-translate-x-1/2 md:top-1/2 md:left-1/2 md:z-10 md:grid-cols-4 md:gap-4 "
